...
function showConfirmationPopUp() {
  ...
  if (popUpWindow && popUpWindow.classList.contains('bottom-[-150px]')) {
    popUpWindow.classList.remove('bottom-[-150px]');
    popUpWindow.classList.add('bottom-[150px]','opacity-1', 'z-50');

    setTimeout(() => {
      popUpWindow.classList.add('bottom-[-150px]');
      popUpWindow.classList.remove('bottom-[150px]','opacity-1', 'z-50');
    }, 3000);
  }
}
